...
function [E_even0,E_odd0,E_even1,E_odd1] = tutorial2(a,m,v0)
...
E_even0 = newton_root(f_even, f_even_prime, 0.7, tol, max_iter);
E_even1 = newton_root(f_even, f_even_prime, 6.2, tol, max_iter);
E_odd0 = newton_root(f_odd,f_odd_prime, 2.8, tol, max_iter);
E_odd1 = newton_root(f_odd,f_odd_prime, 9.8, tol, max_iter);
